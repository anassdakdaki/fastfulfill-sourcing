...
const PROOF_ITEMS = [
  {
    ...
    image: "/site-assets/proof/qc-inspection.png",
    imageAlt: "Product quality inspection before fulfillment",
  ...
  },
  {
    ...
    image: "/site-assets/proof/warehouse-aisle.png",
    imageAlt: "Warehouse aisle with organized inventory shelves",
  ...
  },
  {
    ...
    image: "/site-assets/proof/packaging-inserts.png",
    imageAlt: "Packing table with inserts and packaging materials",
  ...
  },
  {
    ...
    imageAlt: "Shipment tracking workstation with parcel ready to dispatch",
