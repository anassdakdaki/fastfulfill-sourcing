 ...
 * All three can share this endpoint because Shopify sends the topic in the header.
 */
export async function POST(req: NextRequest) {
  ...
  // Log for audit trail. In production you would queue a job to redact/export data
  ...
  switch (topic) {
    case "customers/data_request":
      ...
      console.log("[shopify-gdpr] customers/data_request received with no additional PII stored");
      break;
    ...
    case "customers/redact":
      ...
      console.log("[shopify-gdpr] customers/redact received with customer PII noted for deletion");
      break;
    ...
    case "shop/redact":
      ...
      console.log("[shopify-gdpr] shop/redact received with store data cleanup confirmed");
      break;
